...
export const SingleProduct:React.FC<SingleProductProps> = async ({params}) => {
      ...
      <Wrapper className="primary">
        <div className="flex flex-col lg:flex-row md:px-10 gap-[50px] lg:gap-[100px] ">
          ...
          <div className="flex-[1] py-3">
            ...
            {/* PRODUCT PRIZE */}
            <div className="text-lg font-semibold">MRP: $2000</div>
            ...
            <div className="mb-10">
              <div className="flex justify-between mb-2">
                <div className="text-md font-semibold">Choose size</div>
            ...
            <div>
              ...
              <div className="text-md mb-5">
                ...
                similique consectetur, blanditiis eaque nisi aut ducimus
                voluptates. Distinctio ex, quaerat aliquam, quisquam nihil
                doloribus illum ducimus molestiae perferendis quas voluptate
                maiores amet veritatis a consequatur voluptatem voluptas.
                Doloribus neque quos ad a, veniam modi laboriosam doloremque
                similique in placeat dolorem sunt praesentium odio numquam
                aspernatur quisquam eveniet fugiat natus saepe nihil voluptatum
                quam illo?
              </div>
              <div className="text-md mb-5">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem
