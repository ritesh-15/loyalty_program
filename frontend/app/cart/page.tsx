...
const PaymentForm = ({ handleOrder }: { handleOrder: (data: HandleOrderData) => void }) => {
    ...
    <div className="py-20 w-full">
      <Wrapper className="primary">
          ...
          <div className="flex-[1]">
            ...
            <div className="p-5 my-5 bg-black/[0.05] rounded-xl">
              <div className="flex justify-between">
                ...
                <div className="text-md md:text-lg font-medium text-black">$6000</div>
              </div>
              <div className="text-sm md:text-md py-5 border-t mt-5">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iure unde fugiat dolorum, veritatis reiciendis
                obcaecati cupiditate consectetur nihil nisi deserunt sit voluptas eligendi, velit consequuntur asperiores
                beatae libero! Velit, sed.
              </div>
            </div>
        ...
        <div className="flex-[2] flex flex-col items-center pb-[50px] md:-mt-14">
          <Image src="/empty.jpg" alt="" width={300} height={300} className="w-[300px] md:w-[400px]" />
