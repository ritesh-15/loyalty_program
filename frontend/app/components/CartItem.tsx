                    ...
                    <div className="flex items-center gap-2 md:gap-10 text-black/[0.5] text-sm  md:text-md">
                        <div className="flex items-center gap-1">
                            ...
                            <div className="flex items-center gap-2">
                                <button onClick={handleDecrement} className="hover:text-black bg-gray-300 px-2 py-1 rounded">
                                    -
                                </button>
                                <span>{quantity}</span>
                                <button onClick={handleIncrement} className="hover:text-black bg-gray-300 px-2 py-1 rounded">
                                    +
                                </button>
                            </div>
                        </div>
